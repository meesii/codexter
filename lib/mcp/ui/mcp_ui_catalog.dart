...
class McpUiCatalog {
    ...
    static const file = McpUiGroup(
        id: 'file',
        label: '文件操作',
        description: '读取、写入、编辑、补丁和目录浏览工具。',
    );
    static const search = McpUiGroup(
        id: 'search',
        label: '代码搜索',
        description: '文本搜索、路径匹配和代码结构探索工具。',
    );
    static const terminal = McpUiGroup(
        id: 'terminal',
        label: '终端',
        description: '命令执行和运行会话交互工具。',
    );
    static const git = McpUiGroup(
        id: 'git',
        label: 'Git',
        description: 'Git 状态、差异、历史和分支工具。',
    );
    ...
    static const goal = McpUiGroup(
        id: 'goal',
        label: '目标跟踪',
        description: '多步骤目标创建、更新、校验和完成工具。',
    );
    static const skill = McpUiGroup(
        id: 'skill',
        label: 'Skills',
        description: 'Skills 列表和读取工具。',
    );
    static const downstream = McpUiGroup(
        id: 'mcp',
        label: '下游 MCP',
        description: '下游 MCP 服务器和工具调用。',
    );
    static const summary = McpUiGroup(
        id: 'summary',
        label: '本轮摘要',
        description: '当前一轮处理的摘要。',
    );
