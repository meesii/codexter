...
class ToolSchema {
  ...
  static Map<String, dynamic> _withPurpose(Map<String, dynamic> source) {
    ...
    final required = rawRequired is List ? rawRequired.map((item) => '$item').toList() : <String>[];
...
class ToolAnnotations {
  ...
  static const readOnly = {'readOnlyHint': true, 'destructiveHint': false, 'openWorldHint': false};

  static const write = {'readOnlyHint': false, 'destructiveHint': true, 'openWorldHint': false};
  ...
  static const openWorld = {'readOnlyHint': true, 'destructiveHint': false, 'openWorldHint': true};
