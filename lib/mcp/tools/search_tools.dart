...
class SearchTools {
    ...
    static const _sourceExtensions = <String>{
        'dart', 'ts', 'tsx', 'js', 'jsx', 'py', 'go', 'rs', 'java', 'kt', 'swift',
        'c', 'h', 'cc', 'cpp', 'hpp', 'cs', 'rb', 'php', 'vue', 'svelte', 'sql', 'sh',
    };
    ...
    static const _grepSchema = ToolSchema(
        ...
        meta: {
            'openai/toolInvocation/invoking': '正在搜索…',
            'openai/toolInvocation/invoked': '搜索完成',
        },
    );
    ...
    static const _globSchema = ToolSchema(
        ...
        annotations: ToolAnnotations.readOnly,
        meta: {
            'openai/toolInvocation/invoking': '正在查找文件…',
            'openai/toolInvocation/invoked': '已查找文件',
        },
    );
    ...
    static const _codeExploreSchema = ToolSchema(
        ...
        annotations: ToolAnnotations.readOnly,
        meta: {
            'openai/toolInvocation/invoking': '正在探索代码…',
            'openai/toolInvocation/invoked': '代码探索完成',
        },
    );
}
