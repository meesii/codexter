...
class ProcessTools {
    ...
    static const _execCommandSchema = ToolSchema(
        ...
        meta: {
            'openai/toolInvocation/invoking': '正在执行命令…',
            'openai/toolInvocation/invoked': '命令执行完成',
        },
    );
    ...
    static const _writeStdinSchema = ToolSchema(
        ...
        inputSchema: {
            ...
            'properties': {
                'session_id': {'type': 'integer'},
                'chars': {'type': 'string', 'description': 'Optional stdin characters; \\u0003 sends Ctrl+C'},
                'yield_time_ms': {
                    'type': 'integer',
        ...
        annotations: ToolAnnotations.destructive,
        meta: {
            'openai/toolInvocation/invoking': '正在读取终端…',
            'openai/toolInvocation/invoked': '终端已更新',
        },
    );
}
