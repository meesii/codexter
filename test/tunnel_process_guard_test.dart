...
void main() {
    const configPath =
        r'C:\Users\VCLOUD\AppData\Roaming\codexter\cloudflared.yml';
    ...
    group('TunnelProcessGuard.isOwnedCommand', () {
        ...
        test('正斜杠配置路径也能匹配 Windows 命令行', () {
            const unixStyle =
                'C:/Users/VCLOUD/AppData/Roaming/codexter/cloudflared.yml';
            const command =
                r'cloudflared.exe tunnel --config C:\Users\VCLOUD\AppData\Roaming\codexter\cloudflared.yml run abc';
...
''';
            expect(
                TunnelProcessGuard.parseOwnedPids(listing, configPath),
                [56584, 39516],
            );
        });
